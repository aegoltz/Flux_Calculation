#### Model 18, 4/8/25 ####
# This is a streamlined version of model 17, incorporating some tricks I've learned
# in R since I started this project
library(tidyverse)
...
r_perp_range=c(0.001e3,0.001e3)
...
ConvergenceRate_range=c(2e-2,10e-2)
...
Model_Output_20_All_Vary<-bind_cols(Residualdf,
                        Residualabsdf,
                        TotalFluxdf,
                        DryFluxdf,
                        WetFluxdf,
...
# for Total flux
summary(Model_Output_20_All_Vary$TotalFlux)
# for r_perp
summary(Model_Output_20_All_Vary$r_perp)
